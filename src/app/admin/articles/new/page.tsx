...
export default function NewArticlePage() {
  ...
  const handleTemplateSelect = (type: TemplateType) => {
    ...
    if (!content.trim()) {
      // 仅在内容为空时插入模板
      setContent(generateTemplateMarkdown(type));
    }
  };
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 px-4 py-2 bg-[#06B6D4] text-white text-sm font-semibold rounded-xl hover:bg-[#0891B2] transition-all disabled:opacity-50"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-4">
          <input
            ...
            placeholder="文章标题"
            className="w-full px-4 py-3 rounded-xl bg-[#1E293B]/40 border border-[rgba(30,41,59,0.6)] text-[#F1F5F9] text-lg font-bold placeholder-[#64748B] outline-none focus:border-[#06B6D4]/40"
          />
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setTemplateType(getDefaultTemplateType(e.target.value));
                  }}
