...
export default function AdminDashboard() {
  ...
  const cards = [
    ...
    { icon: Send, label: "待审投稿", count: stats.pendingSubs, color: "text-[#F59E0B]", bg: "bg-[#F59E0B]/10", href: "/admin/submissions", badge: stats.pendingSubs > 0 },
    { icon: Wallet, label: "待审提现", count: stats.pendingWds, color: "text-[#EF4444]", bg: "bg-[#EF4444]/10", href: "/admin/withdrawals", badge: stats.pendingWds > 0 },
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        {cards.map((c) => (
          <LinkNoPrefetch key={c.label} href={c.href || "#"} className={`${c.bg} rounded-xl p-5 border border-[rgba(30,41,59,0.4)] hover:border-[rgba(6,182,212,0.2)] transition-all block relative`}>
